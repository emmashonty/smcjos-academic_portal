              	...
              	<div class="box box-primary">
                	<div class="box-header with-border">
                        		...
                        		<div class="col-md-6">
                                    ...
                                    <div class="form-group" id="divIName">
                                        ...
                                        <div class="col-xs-9" id="divIName1">
                                            <input type="text" class="form-control" placeholder="Enter Class" name="s_class" id="s_class" autocomplete="off">
                                        </div>                    
                                    </div>
                        				...
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divPhone">
                                                ...
                                                <div class="col-xs-7" id="divPhone1">
                                                	<input type="text" class="form-control" id="phone" name="phone" placeholder="080-0000-0000">
                                                </div> 
                                        	</div>  
                        			   	...
                        			   	<div class="col-xs-5">
                                        	<div class="form-group" id="divPhoto">
                                                ...
                                                <div class="col-xs-3" id="divPhoto1" style="height:150px;">
                                                    ...
                                                    <input type="file" name="fileToUpload" id="fileToUpload" style="margin-top:7px;"  />size 95kb
                                                </div>
                                            </div>
                                        </div>
                                    </div>                
                        				...
                        				<div class="col-xs-7">
                                            <div class="form-group" id="divGPhone">
                                                ...
                                                <div class="col-xs-7" id="divGPhone1">
                                                	<input type="text" class="form-control" id="g_phone" name="g_phone" placeholder="080-0000-0000" >
                                                </div> 
                                        	</div>
                       ...
                       <div class="box-footer text-right">
                    		...
                    		<button style="width:150px;" type="submit" class="btn text-right btn-success asd" id="btnSubmit">Add Student/Guardian</button><br>
                             
<?php

//$current_day_no=date("d");
//if($current_day_no > 31){
...
$("form").submit(function (e){
	...
	if(index_number == '' || g_index_number == '' || full_name == '' || g_full_name == '' || s_class == '' || g_s_class == '' || address == '' || g_address == '' || gender == 'Select Gender' || g_gender == 'Select Gender' || b_date == '' || g_b_date == '' || email == '' || mailformat.test(email) == false || g_email == '' || mailformat.test(g_email) == false || telformat.test(phone) == false || telformat.test(g_phone) == false || photo == '' || g_photo == '' || phone == ''  || g_phone == '' ) {
