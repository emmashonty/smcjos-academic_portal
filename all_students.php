...
?>   
               ...
               <!--MSK-000115-td2--><td id="td2_<?php echo $row['id']; ?>"><?php echo $row['s_class']; ?></td>
...
<?php
$sql1="SELECT * FROM student WHERE index_number='$sr_id'";
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(myArray[0]==1){//MSK-000130
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000131-Start Ajax  
						...
						xhttp1.open("GET", "show_all_student_table.php" , true);												
