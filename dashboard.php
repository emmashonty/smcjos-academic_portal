...
?>  
    ...
    <section class="content">
      <!-- Info boxes -->
      <div class="row">
        <div class="col-md-4 col-sm-7 col-xs-13">
          <div class="info-box">
...
?>             
              ...
              <span class="info-box-number"><small>N</small><?php echo $monthly_income; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
?>             
              ...
              <span class="info-box-number"><small>N</small><?php echo $total_income; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
function ShowEvents(status,my_index,my_type){
	...
	var d = new Date();    //new Date('2021','01','01');
...
for($i=0; $i<count($month); $i++){
	$sql="SELECT COUNT(id) FROM student WHERE reg_year='$current_year' AND reg_month='$month[$i]'";
	$result=mysqli_query($conn,$sql);
	$row=mysqli_fetch_assoc($result);
