						...
						var xhttp = new XMLHttpRequest();
							xhttp.onreadystatechange = function() {
								...
								if (this.readyState == 4 && this.status == 200) {
									...
									var lastPaid = document.getElementById('lastPaid').innerHTML.replace("N", " ");
									var dueAmount = document.getElementById('dueAmount').innerHTML.replace("N", " ");
									var currentPaid = document.getElementById('currentPaid').innerHTML.replace("N", "");
